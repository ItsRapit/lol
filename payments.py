        ...
        try:
            if isinstance(event, Message):
                ...
                if event.message and event.message.chat.type != "private":
                    allowed_prefixes = ("tx:", "qrev:", "qadmin:", "qact:", "report_ignore:", "gquiz:", "gqgenre:", "gqcontinue:", "gqgenrei:", "gqcontinuei:", "gqtime:", "gqcount:", "group_quiz_join_inline", "group_quiz_join", "group_quiz_start", "group_quiz_leave", "group_duel_accept", "group_duel_leave", "group_duel_close", "gduelgenre:", "gduelans:", "gqreport:", "gdreport:")
